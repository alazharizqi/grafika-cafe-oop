...
public class Activity implements Initializable {
    ...
    @FXML
    public TableView<ModelActivity> table;

    @FXML
    public TableColumn<ModelActivity, String> employee;

    @FXML
    public TableColumn<ModelActivity, String> activity;

    @FXML
    public TableColumn<ModelActivity, String> date;

    ObservableList<ModelActivity> activitiesList = FXCollections.observableArrayList();
    ...
    public void getActivitiesItem() {
        ...
        try {
            ...
            while(resultSet.next()) {
                activitiesList.add(new ModelActivity(
